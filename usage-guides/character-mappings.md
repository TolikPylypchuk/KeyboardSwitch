...
![The character mappings tab when the configuration is empty](../.gitbook/assets/v4.1-screen-char-mappings-empty.png)
...
![The character mappings tab after auto-configuration](../.gitbook/assets/v4.1-screen-auto-configuration.png)
