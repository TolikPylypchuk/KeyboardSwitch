...
The converter lets you manually convert text between arbitrary layouts, not just those installed in your system. In order to enable it, check the 'Show the converter' checkbox in the Preferences tab.
