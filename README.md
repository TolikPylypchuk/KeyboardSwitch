...
{% hint style="info" %}
If you're using version 4.0, then you should upgrade to version 4.2 as soon as possible since it contains several improvements and bug fixes.
{% endhint %}
...
{% hint style="info" %}
The app simulates pressing _Ctrl+C_ to copy and _Ctrl+V_ to paste text. This is the default behavior for most (if not all) applications. But if you are working in an app which behaves differently on those key presses, this app will not be able to instantly switch text. You can disable this behavior, and copy/paste the text manually.
{% endhint %}
